#assignment 1
# question 12
# this is a program to solve tower of hanoi problem the user inputs the number of disks and the program outputs the steps taken to solve the problem
...
Author: .asciiz "Author: Gautham M\n"
diskno: .asciiz "disk no :"
MoveAB: .asciiz "\nMove disk from 1 to 2\n"
MoveAC: .asciiz "\nMove disk from 1 to 3\n"
MoveBC: .asciiz "\nMove disk from 1 to 3\n"
MoveBA: .asciiz "\nMove from disk 2 to 1\n"
MoveCB: .asciiz "\nMove from disk 3 to 2\n"
MoveCA: .asciiz "\nMove from disk 3 to 1\n"
...
#    This is the decision structure to decide which prompt to print   #
 FromA:
	...
	beq $a3, $t5, PrintAC	#Source is A, Dest is C
...
PrintAB:
	...
	la  $a0, diskno
	syscall
	addi $v0, $0, 1			  #print the result to sys call 1
    add $a0, $t7, $0          # store value of t2 in a0
    syscall
	li  $v0, 4 #Print the Move from A to B
	la  $a0, MoveAB
	syscall
